...
public enum ErrorType {
    ...
    NOT_EXIST_BUSINESS_SCHEDULE(1606, "스케줄이 존재하지 않습니다"),
    ONLY_OWNER_CAN_REVISE_BUSINESS_SCHEDULE(1607, "자신의 것이 아닌 스케줄은 수정하지 못합니다."),
    ...
    NOT_EXIST_BUSINESS_SCHEDULE_RELATED_TO_THE_BUSINESS(1624, "연관사업의 스케줄이 존재하지 않습니다.");
